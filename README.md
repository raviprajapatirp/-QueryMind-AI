...
| **UI** | "Notebook Desk" theme — bright, student-facing e-learning look (periwinkle-white background, ink-navy text, indigo + coral accents, Baloo 2 display type) with a "Night Study" dark mode toggle, rounded lesson-chip sidebar nav, gradient KPIs, searchable sidebar |
